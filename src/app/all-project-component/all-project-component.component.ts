...
export class AllProjectComponentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.projectgoMatch = new Project('GoMatch', 'School', 'Site ayant pour objectif de regrouper les utilisateurs sur des terrains multisports enregistrés sur notre plateforme.', 'https://github.com/Marwin-Rdgs/GoMatch.fr', 'https://gomatch.marwin-rodrigues.fr/', 'https://drive.google.com/drive/folders/1D7lzdfPTlvgoTj-l3XW1ej1c8G5FRcgB?usp=sharing', '../../assets/img/gomatch.gif');
    this.projectcitadelle = new Project('Citadelle de Besançon', 'School', "Illustration animée de la Citadelle de Besançon, réalisé sur Illustrator et exporté en SVG afin d'être entièrrement animée en CSS natif", 'https://github.com/Marwin-Rdgs/Animated_Footer-Template', '#', '#', '../../assets/img/citadelle.jpg');
    this.projectfooterWave = new Project('Template Footer', 'Personel', "Template d'un bas de page (footer) animé tels des vagues d'eau. Possibilité d'éditer la liste des pages, des icônes la partie basse de ce dernier.", '#', 'https://citadelle-besancon.marwin-rodrigues.fr/', '#', '../../assets/img/footer_wave.jpg');
