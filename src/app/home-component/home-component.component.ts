...
export class HomeComponentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.clientAlternance = new Client('Andréa LOPES', 'Chef de projet', 'Forvia', 'https://www.faurecia.com/','../../assets/clients/AndréaLopes.jpeg','Bsahtek le tipeu');
    ...
    this.clientChatonnay = new Client('Pascal CHATONNAY', 'Ensaignant', 'MMI Montbéliard', 'https://www.linkedin.com/school/mmimontbeliard/?originalSubdomain=fr','../../assets/clients/pascalChatonnay.jpg','trop bien');
    this.clientDany = new Client('Dany GALMICHE', 'Auto-entrepreneur', 'Dany Galmiche Design', 'https://www.instagram.com/danyg_design/','../../assets/clients/danyGalmiche.jpeg',"J'adore zebi");
